...
public class FragmentCategories extends Fragment {
    ...
    public static FragmentCategories newInstance(Serializable brandsCategories) {
    ...
    public interface OnListItemSelectedListener {
        void OnListItemSelected(Integer categoryId, String category);
    }
    ...
    public class MyAdapter extends SimpleAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent){
            ...
            brandsCount.startAnimation(AnimationUtils.loadAnimation(getContext(),android.R.anim.slide_in_left));


            // Then we get reference for Picasso
                ImageView img = (ImageView) v.findViewById(R.id.cat_list_image);
//                v.setTag(img); // <<< THIS LINE !!!!
            // get the image from the data you passed to the `Map`

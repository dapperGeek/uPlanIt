...
public class Constants {
    ...
    //Server url for new user registration
    public static final String BRAND_URL = String.format("%sbrand_details.php", serverUrl);
    ...
    //Retrieve gallery url
    public static final String deleteFromGalleryUrl = String.format("%sdeleteGalleryImage.php", serverUrl);
    ...
    public static final int maxUploadCount = 12;
